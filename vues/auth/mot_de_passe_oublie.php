        ...
        <div class="login-wrapper">
            <div class="login-form-side">
                ...
                <h1>Gestion de Stock</h1>
                        ...
                        <?php endif; ?>
                <h5 class="text-center mb-4">Mot de passe oublié</h5>
                        ...
                        <form action="index.php?controleur=auth&action=envoyerReinitialisationMotDePasse" method="post">
                    <div class="form-group">
                                <label for="email" class="form-label">Adresse email</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Votre adresse email" required autofocus>
                                </div>
                            </div>
                        ...
                        <div class="back-to-login">
                            <a href="index.php?controleur=auth&action=connexion">
